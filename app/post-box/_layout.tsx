...
import {
	type LikedMeFilter,
	PostBoxFilterContext,
} from '@/src/features/post-box/post-box-filter-context';
...
export default function ProfileEditLayout() {
	...
	const activeTab = pathname.split('/')[2] ?? 'liked-me';
	...
	return (
		<PostBoxFilterContext.Provider value={{ filter, setFilter }}>
			<Layout.Default style={[styles.container, { paddingBottom: insets.bottom }]}>
				<PostBoxHeaders />
