...
import { ActivityIndicator, Platform, Text as RNText, StyleSheet, View } from 'react-native';
...
export default function OnboardingProfilePhotoPage() {
	...
	const handleSubmit = async () => {
		...
		if (validImages.length < 1) {
			showErrorModal(t('features.onboarding.profile_photo.min_one_required'), 'announcement');
			return;
		}
