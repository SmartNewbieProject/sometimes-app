...
export default function SmokingSelectionScreen() {
	...
	const tooltips = usePreferenceTooltips('apps.my-info.smoking', preferences?.options.length ?? 0);
	useEffect(() => {
	...
	useFocusEffect(useCallback(() => updateStep(MyInfoSteps.SMOKING), [updateStep]));
