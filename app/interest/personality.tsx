...
export default function PersonalitySelectionScreen() {
	...
	const nextMessage = (() => {
		...
		return t('apps.interest.index.button_next');
	})();
	...
	useFocusEffect(useCallback(() => updateStep(InterestSteps.PERSONALITY), [updateStep]));
		...
		<Layout.Default>
			...
			<View style={styles.contentContainer}>
				...
				<View style={styles.indicatorRow}>
					<View style={{ flex: 1 }} />
					<StepIndicator length={3} step={personality?.length ?? 0} dotGap={4} dotSize={16} />
				</View>

				<View style={styles.bar} />

				<View style={styles.chipSelector}>
					<Loading.Lottie title={t('apps.interest.personality.loading')} loading={isLoading}>
						<ChipSelector
							value={personality}
							options={
