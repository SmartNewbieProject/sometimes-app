...
import {
	useMarkAllAsRead,
	useDeleteAllRead,
} from '@/src/features/notification/queries/use-notification-mutations';
...
export default function NotificationPage() {
	...
	const handleNotificationPress = (notification: any) => {
		...
		console.warn(
			'[Notification] No redirectUrl or deepLink provided for notification:',
			notification.id,
		);
	};
	...
	const handleMarkAllAsRead = () => {
		showModal({
			...
			children: <Text>{t('apps.notification.index.modal_mark_all_read_desc')}</Text>,
			primaryButton: {
				text: t('apps.notification.index.modal_confirm'),
				onClick: () => {
	...
	const handleDeleteAllRead = () => {
		showModal({
			...
			children: <Text>{t('apps.notification.index.modal_delete_all_read_desc')}</Text>,
			primaryButton: {
				text: t('apps.notification.index.modal_confirm'),
				onClick: () => {
