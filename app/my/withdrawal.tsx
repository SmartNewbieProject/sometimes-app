...
export default function WithdrawalScreen() {
	...
	const onSubmitWithdrawal = handleSubmit(async (data) => {
		...
		accountEvents.trackAccountDeletionRequested(reason, isOther ? otherReason : undefined);
	...
	return (
		<Layout.Default>
			<Header.Container>
				<Header.LeftContent>
					<Header.LeftButton onPress={() => router.navigate('/setting/account')} visible />
				</Header.LeftContent>
			...
			<ScrollView style={styles.container}>
				<View style={styles.topContainer}>
					<View>
						<Image source={require('@assets/images/withdrawal-miho.webp')} style={styles.image} />
					</View>
