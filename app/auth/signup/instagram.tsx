          ...
          <View>
            ...
            <View style={[styles.contentWrapper, { zIndex: 10 }]}>
              ...
              {Platform.OS === 'web' ? (
                ...
                <View style={[
                  styles.inputWrapper,
                  isFocused && { borderBottomColor: '#7C3AED' }
                ]}>
                  <Text style={[
                    styles.instagramText,
                    {
                      ...
                      // @ts-ignore
                      animation: instagramId.length > 0 ? 'textGlow 2s ease-in-out infinite' : 'none',
                    }
                  ]}>
                    @
                  </Text>
                ...
                <Animated.View style={[styles.inputWrapper, inputWrapperAnimatedStyle]}>
                  <Animated.Text style={[styles.instagramText, atSymbolAnimatedStyle, atSymbolGlowAnimatedStyle]}>
                    @
                  </Animated.Text>
                  <TextInput
                    value={instagramId}
