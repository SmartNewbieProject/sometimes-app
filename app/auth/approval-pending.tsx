	...
	return (
		<DefaultLayout style={styles.container}>
			...
			<ScrollView style={styles.scrollView} contentContainerStyle={{ flexGrow: 1 }}>
				<View style={styles.contentWrapper}>
					...
					<View style={styles.imageContainer}>
						...
						<Image
							source={statusData?.profileImage ?? require('@/assets/images/signup-pending.webp')}
					...
					<View style={styles.titleContainer}>
						<Text size="lg" textColor="black" weight="semibold" style={styles.centerText}>
							{t('apps.auth.approval-pending.title')}
						</Text>
						<Text size="lg" textColor="black" weight="normal" style={styles.subtitleText}>
					...
					<View style={styles.descContainer}>
						<Text size="sm" textColor="pale-purple" weight="light" style={styles.centerText}>
							...
							<View style={styles.cardRow}>
								...
								<View style={styles.flex1}>
									...
									<Text size="sm" textColor="gray" weight="light">
										{t('apps.auth.approval-pending.card_desc')}
									</Text>
								</View>
							</View>
						</View>
			...
			<View style={[styles.bottomContainer, { paddingBottom: insets.bottom + 32 }]}>
				<Button variant="primary" size="md" onPress={handleGoToLogin} styles={styles.button}>
