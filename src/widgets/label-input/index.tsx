import { Input, Label, Text } from '@/src/shared/ui';
...
export function LabelInput({
	...
	return (
		<View className={cn(labelInput({ size }), wrapperClassName)}>
			<Label label={label} required={required} size={size} textColor={textColor} />

			{description && (
				<Text size={size} textColor="black" className="mb-1">
					{description}
				</Text>
			)}
