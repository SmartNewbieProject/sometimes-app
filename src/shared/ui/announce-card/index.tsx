...
const cardClass = cva(
	['w-full h-[42px]', 'flex flex-row items-center gap-x-2.5 px-4', 'rounded-[20px]'],
	{
		variants: {
			theme: {
...
export const AnnounceCard = ({
	...
	return (
		<TouchableOpacity className={cardClass({ theme })} activeOpacity={0.4} onPress={onPress}>
			{theme === 'alert' && (
				<ImageResource
			...
			<Text size="13" weight="bold" className={textClass({ theme })}>
				{text}
			</Text>
		</TouchableOpacity>
	);
