...
const SHEET_HEIGHT = isWeb ? Math.min(600, SCREEN_HEIGHT * 0.7) : SCREEN_HEIGHT * 0.7;
...
function WebBottomSheetPicker({
	...
	const keyExtractor = useCallback((item: BottomSheetPickerOption) => item.value, []);
				...
				>
					...
					{title && (
						<View style={styles.titleContainer}>
							<Text size="lg" weight="bold" textColor="primary" style={styles.title}>
								{title}
							</Text>
						</View>
					)}
					...
					{searchable && (
						<View style={styles.searchContainer}>
							<View style={styles.searchInputWrapper}>
								<SearchIcon width={16} height={16} color={semanticColors.text.muted} />
								<TextInput
									ref={searchInputRef}
