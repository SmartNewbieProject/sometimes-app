...
export function CharacterPromptModal({
  ...
  }, [visible, animationDuration, animationDelay, springDamping, springStiffness]);
        ...
        <Animated.View style={[styles.modalContainer, contentAnimatedStyle]}>
          ...
          <View style={styles.speechBubbleContainer}>
            <View style={styles.speechBubble}>
              <Text style={styles.speechText}>{title}</Text>
              ...
              <View style={styles.rewardContainer}>
                ...
                <View>
                  ...
                  <Text style={styles.rewardSubtext}>{rewardSubtext}</Text>
                </View>
              </View>
