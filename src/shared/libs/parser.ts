import { PreferenceTypeGroup } from "@/src/types/user";
 ...
 */
const getPreferenceOptions = <T extends string = string>(
  typeName: string,
 ...
 */
const getMultiplePreferenceOptions = <T extends string = string>(
  typeNames: string[],
  preferences: PreferenceTypeGroup[]
  ...
  typeNames.forEach(typeName => {
    result[typeName] = getPreferenceOptions<T>(typeName, preferences);
  });
