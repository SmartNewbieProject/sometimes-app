...
import { UniversityImage, getSmartUnivLogoUrl, getUnivLogo } from '@/src/shared/libs';
import { useMutation, useQuery } from '@tanstack/react-query';
import { useGlobalSearchParams } from 'expo-router';
import { useTranslation } from 'react-i18next';
import { getUniversitiesByRegion } from '../apis';
import { useSignupProgress } from '../hooks';
import { getAllRegionList, getRegionListByCode, getRegionsByRegionCode } from '../lib';
