...
export default function Logo() {
	...
	const [longPressTimeout, setLongPressTimeout] = useState<ReturnType<typeof setTimeout> | null>(
		null,
	);
	...
	return (
		<View style={[logoStyles.container, { paddingTop: insets.top }]}>
			...
			<View style={logoStyles.taglineWrapper}>
				<Pressable onLongPress={() => setIsEmailLoginModalVisible(true)} delayLongPress={2000}>
			...
			<AppleReviewModal isVisible={isModalVisible} onClose={() => setIsModalVisible(false)} />
