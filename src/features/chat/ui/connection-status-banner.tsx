				...
				<View style={styles.modalOverlay}>
					<View style={styles.modalContent}>
						...
						<Text style={styles.modalTitle}>
							{t('features.chat.ui.connection_status.reconnecting_title')}
						</Text>
						{reconnectAttempt > 0 && (
							<Text style={styles.modalAttempt}>
								{t('features.chat.ui.connection_status.reconnect_attempt', {
						...
						{countdown > 0 ? (
							<Text style={styles.modalSubtitle}>
								{t('features.chat.ui.connection_status.reconnect_countdown', {
									seconds: countdown,
								})}
							</Text>
						) : (
							<Text style={styles.modalSubtitle}>
								{t('features.chat.ui.connection_status.please_wait')}
							</Text>
						)}
					</View>
				</View>
