...
function WebChatInput() {
	...
	const handleSend = () => {
		...
		if (!textareaRef.current || chat === '' || !roomDetail?.partnerId || !user.id) {
			return;
		}
	...
	return (
		<>
			<div style={webStyles.container}>
				<button onClick={handlePress} type="button" style={webStyles.plusButton}>
					<PlusIcon />
				</button>
				...
				<div style={webStyles.inputWrapper}>
					...
					/>
					<textarea style={webStyles.hiddenTextarea} readOnly ref={cloneRef} rows={1} />
