...
export default function TotalMatchCounter({ count, className }: TotalMatchCounterProps) {
		...
		>
			<View style={styles.contentContainer} className="whitespace-nowrap">
				<View style={styles.leftContent} className="w-full flex flex-row">
					<Text textColor="white" className="mb-1 whitespace-nowrap text-sm md:text-md pt-5 pr-1">
						지금까지
					</Text>
					<View style={styles.counterContainer} className="self-center flex justify-center">
						<Text weight="bold" textColor="white" className="text-[34px] tracking-wide font-rubik">
							{formattedCount}
						</Text>
					</View>
					<Text textColor="white" className="self-end text-sm md:text-md pb-[19px]">
						명이 신청했어요!
					</Text>
				</View>
			</View>
