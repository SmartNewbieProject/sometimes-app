...
const reviews: Review[] = [
  {
    ...
    content: "처음에는 인스타에서 광고형식으로 마주했는데요.😀 부산지역까지 확장한다는 광고에 속는 셈 치고 가입 해봤습니다! 현재는 매칭을 통해 만난 좋은 친구가 생겼고 그와 동시에 최근 매칭에서 연이 닿은 예쁜 썸녀가 한 분 생겼습니다. 다른 앱들에 비해서 현질유도와 현질의 의미가 크지 않고 현질 없이도 좋은 인연 만들 수 있는 가장 좋은 어플이라고 생각합니다! 개발자 선배님들 진심으로 존경하고 감사하고 사랑합니다!! ❤️❤️❤️",
    date: "25.08.10",
  },
  {
    name: "익명",
    ...
    content: "다른앱들 보면 보통 서울이나 수도권이어서 사람들이 대부분이어서 아쉬웠는데 대전에서 사람 만날 수 있어서 좋고 매주 두번씩 매칭해주니 이상형 바로 찾았다 잘생긴사람 많아서 좋아요 그리고 무엇보다 안전한 앱인거 같아요 !!",
    date: "25.08.09",
  },
  {
    name: "익명",
  ...
  },
  {
    ...
    universityName: UniversityName.경성대학교,
    universityImageUrl: getUnivLogo(UniversityName.경성대학교),
    content: "기존에 다른 소개팅어플은 이상형을 참고해서 해준다 하고 전혀 반영이 안되거나 아무나 막 매칭되는 경우가 많았는데 썸타임은 이상형 반영해서 ai가 매칭해주는 거라 정확성이 높은 것 같아용 더 두고 보면서 사용해볼 예정!~! 대학생끼리 하는거라 더 좋은 것 같아요🥰",
    date: "25.08.09",
  },
];
