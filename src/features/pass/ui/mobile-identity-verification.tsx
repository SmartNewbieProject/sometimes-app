...
import { IdentityVerification, type PortOneController } from '@portone/react-native-sdk';
import { useRef } from 'react';
import { Modal, StatusBar, View, TouchableOpacity, Text as RNText, StyleSheet } from 'react-native';
 ...
 */
export const MobileIdentityVerification: React.FC<MobileIdentityVerificationProps> = ({
	request,
	onComplete,
	onError,
	onCancel,
	...
	const handleComplete = (response: unknown) => {
		...
		if (responseObj.code != null) {
			const errorMessage =
				...
				t('features.pass.mobile-identity-verification.verification_failed');
		...
		>
			...
			>
				<View style={modalStyles.header}>
					...
					<RNText style={modalStyles.headerTitle}>
						{t('features.pass.mobile-identity-verification.title')}
					</RNText>
