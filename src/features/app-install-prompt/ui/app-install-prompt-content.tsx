...
import { getAndroidStoreUrl, getIOSStoreUrl } from '@/src/shared/libs/platform-utils';
	...
	return (
		...
		>
			<Pressable
				...
				style={[styles.badgeButton, isHovered && styles.badgeButtonHovered]}
			>
				<Image source={source} style={styles.badgeImage} resizeMode="contain" />
			</Pressable>
		</View>
	);
};
	...
	const benefits = [
		{
			...
			text: t('features.app-install-prompt.ui.benefits.realtime_notification'),
		},
	...
	return (
		<View style={styles.modalContainer}>
			...
			<View style={[styles.dismissContainer, styles.fadeSlideIn, { animationDelay: '0.6s' }]}>
				<Text size="sm" textColor="gray" style={styles.dismissText} onPress={onDismiss}>
