...
export const rouletteModalStrategy = (
		...
		showNestedModal({
			...
			children: (
				<View style={styles.modalChildren}>
					<Text style={styles.modalChildrenText}>급하게 다가가기보다 상대의 마음을</Text>
					<Text style={styles.modalChildrenText}>천천히 지켜보는게 좋아요</Text>
				</View>
			),
			primaryButton: {
				text: i18n.t('common.닫기'),
				onClick,
			},
			showLogo: (
				<View
		...
		showNestedModal({
			...
			children: (
				<View style={styles.modalChildren}>
					...
					<Text style={styles.modalChildrenText}>상대방의 마음이 스며들 수 있어요</Text>
				</View>
			),
			...flyweight(onClick),
		}),
		...
		showNestedModal({
			...
			children: (
				<View style={styles.modalChildren}>
					...
					<Text style={styles.modalChildrenText}>조금 더 마음을 열어도 좋은 날이에요</Text>
				</View>
			),
			...flyweight(onClick),
		}),
	3: () =>
		showNestedModal({
			...
			children: (
				<View style={styles.modalChildren}>
					<Text style={styles.modalChildrenText}>대화의 흐름이 부드럽게 이어지고</Text>
	...
	4: () =>
		showNestedModal({
			...
			children: (
				<View style={styles.modalChildren}>
					<Text style={styles.modalChildrenText}>새로운 인연이 들어오거나,</Text>
					<Text style={styles.modalChildrenText}>오래된 관계가 한 단계 더 깊어질 수 있어요</Text>
				</View>
			),
			...flyweight(onClick),
		}),
	5: () =>
		showNestedModal({
			...
			children: (
				<View style={styles.modalChildren}>
					<Text style={styles.modalChildrenText}>마음이 통하는 순간이 찾아옵니다</Text>
					<Text style={styles.modalChildrenText}>사랑의 신이 미소 짓는 하루!</Text>
				</View>
			),
			...flyweight(onClick),
		}),
