...
export const CommunityEventPromptModal: React.FC<CommunityEventPromptModalProps> = ({
	...
	const handlePress = useCallback(() => {
		...
		]).start(() => onWriteArticle());
	}, [onWriteArticle, translateY, chipOpacity]);
			...
			<Pressable onPress={handlePress} style={styles.chip}>
				...
				<View style={styles.textContainer}>
					...
					<Text style={styles.subtitle} numberOfLines={1}>
						{t('features.event.ui.community_event_prompt.write_button')} {t('features.event.ui.community_event_prompt.gem_label')} {t('features.event.ui.community_event_prompt.reward_subtext')}
					</Text>
