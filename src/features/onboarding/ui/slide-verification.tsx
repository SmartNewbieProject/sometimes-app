...
const MAX_BADGE_WIDTH = 280;
const badgeWidth = Math.min(width * 0.7, MAX_BADGE_WIDTH);
	...
	return (
		<View style={styles.container}>
			<View style={styles.content}>
				<Text style={styles.headline}>{t('features.onboarding.slides.verification.headline')}</Text>
				<Text style={styles.subtext}>{t('features.onboarding.slides.verification.subtext')}</Text>
