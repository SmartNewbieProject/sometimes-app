		...
		return (
			<View style={styles.container}>
				<View style={styles.content}>
					...
					<Text style={styles.subtext}>{t('features.onboarding.ui.login_subtext')}</Text>
					...
					<View style={styles.loginButtonsContainer}>
						...
						>
							<Text style={styles.passButtonText}>{t('features.onboarding.ui.pass_login')}</Text>
						</Button>
						...
						<Pressable onPress={handleKakaoLogin} style={styles.kakaoButton}>
							...
							<Text style={styles.kakaoButtonText}>{t('features.onboarding.ui.kakao_login')}</Text>
						</Pressable>
						...
						<Show when={Platform.OS === 'ios'}>
							<Pressable onPress={handleAppleLogin} style={styles.appleButton}>
								<Text style={styles.appleButtonText}>
									{' '}
									{t('features.onboarding.ui.apple_login')}
								</Text>
							</Pressable>
						</Show>
					</View>
