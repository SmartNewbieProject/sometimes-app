...
export const TypingEffect = ({ isActive }: TypingEffectProps) => {
	...
	const message1 = t('features.onboarding.ui.typing_message1');
	const message2 = t('features.onboarding.ui.typing_message2');
	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.bubbleRight}>
				<Text style={[styles.bubbleText, styles.bubbleTextRight]}>{displayText2}</Text>
			</View>
		</View>
	);
};
