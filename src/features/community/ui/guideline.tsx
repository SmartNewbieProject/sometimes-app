...
export const CommunityGuideline = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.textLargeGap}>{t("features.community.ui.guideline.guideline_purpose")}</Text>
      ...
      <Text style={styles.textLargeGap}>{t("features.community.ui.guideline.writing_tips_title")}</Text>
      ...
      <Text style={styles.text}>{t("features.community.ui.guideline.report_and_sanction_title")}</Text>
      <Text style={styles.textSmallGap}>{t("features.community.ui.guideline.sanction_message_1")}</Text>
      <Text style={styles.textSmallGap}>{t("features.community.ui.guideline.sanction_message_2")}</Text>
    </View>
  );
};
