...
interface FilterButtonProps {
  activeTab: 'realtime' | 'popular' | 'review';
  onChangeTab: (tab: 'realtime' | 'popular' | 'review') => void;
}
    ...
    <View className="px-4 py-2">
      <View className="flex-row gap-2">
        ...
        >
          ...
          <Text className="text-[12px] h-[18] w-[39] pt-[1px]" textColor={activeTab === 'realtime' ? 'white' : 'black'}>실시간</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity className={`w-[94px] h-[40px] flex-row items-center justify-center rounded-[10px] py-1.5 px-3 ${
        ...
        >
          ...
          <Text className="text-[13px] h-[18] w-[39]" textColor={activeTab === 'review' ? 'white' : 'black'}>리뷰</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
