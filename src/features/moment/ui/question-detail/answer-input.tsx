...
export const AnswerInput: React.FC<AnswerInputProps> = ({
	...
	const renderLines = () => {
		return (
			<View
				pointerEvents="none"
				style={[StyleSheet.absoluteFill, { paddingTop: 9, paddingHorizontal: 24 }]}
			>
		...
		<View style={answerInputStyles.container}>
          ...
          */}
					...
					<Text
						...
						style={[answerInputStyles.statusText]}
					>
						{questionType === 'text'
							? t('features.moment.question_detail.answer_input.writing_count', {
									count: textAnswer.length,
								})
							: isOptionValid
			...
			<View style={answerInputStyles.submitButton}>
				<Button
					...
					styles={{
						backgroundColor:
							isValid && !isSending ? semanticColors.brand.primary : colors.cardPurple,
				...
				>
					{isSending ? (
						<View style={{ flexDirection: 'row', alignItems: 'center' }}>
							...
							<Text textColor="white" weight="bold">
								{t('features.moment.question_detail.answer_input.sending')}
							</Text>
						</View>
					) : (
