...
export const UnrespondedCard = ({
	blocked = false,
	blockedReason = null,
	blockedMessage = null,
}: UnrespondedCardProps) => {
	...
	return (
		<TouchableOpacity
			...
			accessibilityLabel={`${cardContent.title}, ${cardContent.subtitle}`}
			accessibilityHint={
				blocked ? undefined : t('features.moment.my_moment.question_card.go_to_answer_hint')
			}
		>
			<Image
				source={
					blocked
						? require('@/assets/images/moment/envelope-heart.webp')
						: require('@/assets/images/moment/envelope.webp')
				}
				style={styles.icon}
				resizeMode="contain"
				accessible={false}
