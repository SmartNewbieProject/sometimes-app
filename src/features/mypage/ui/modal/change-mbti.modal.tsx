	...
	return (
		<View className="flex flex-col items-center gap-y-4 ">
			<View className="flex flex-col w-full">
				<Text className="text-2xl font-bold" textColor="black">
					MBTI 변경
				</Text>
			...
			<MbtiSelector value={mbtiValue} onChange={setMbtiValue} onBlur={() => {}} />

			<View className="flex flex-row items-center gap-x-2 mt-4 justify-center">
				<Button variant="outline" onPress={hideModal}>
					나중에 할래요.
				</Button>
				<Button variant="primary" onPress={onUpdateMbti}>
					변경할게요
				</Button>
			</View>
		</View>
