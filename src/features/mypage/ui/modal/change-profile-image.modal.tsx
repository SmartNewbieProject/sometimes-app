...
import { handleProfileImageError } from '@/src/features/profile/services/profile-image-error-handler';
...
export const ChangeProfileImageModal = ({ onCloseModal }: ChangeProfileImageModalProps) => {
	...
	return (
		<DefaultLayout style={[styles.defaultLayout, Platform.OS === 'web' && styles.webLayout]}>
			<View style={{ flex: 1 }}>
				<GuideView>
					...
					{!visible && (
						<Animated.View
							style={[
								height < guideHeight ? styles.infoWrapper : styles.infoOverlayWrapper,
				...
				<View style={styles.bottomContainer}>
					<Layout.TwoButtons
						...
						content={{
							next: isSubmitting
								? t('features.mypage.image-modal.saving')
								: t('features.mypage.image-modal.save'),
						}}
